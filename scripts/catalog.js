...
const products = [
    { name: "Remera Vent Verde", price: 15000, img: "assets/catalog/remera-1.png", link: "producto.html", category: "remeras", materials: ["algodon"] },
    { name: "Bolso CICA Neumático negro", price: 35000, img: "assets/catalog/bolso.png", link: "producto.html", category: "accesorios", materials: ["camaras"] },
    { name: "Jerséi de lana reciclada", price: 25000, img: "assets/catalog/jersei.png", link: "producto.html", category: "remeras", materials: ["lana"] },
    { name: "Sneaker Spandau Navy Man", price: 30000, img: "assets/catalog/zapatillas-1.png", link: "producto.html", category: "calzado", materials: ["poliester"] },
    { name: "Pantalones Cargo Ethica Azules", price: 27000, img: "assets/catalog/pantalones.png", link: "producto.html", category: "pantalones", materials: ["algodon", "poliester"] },
    { name: "Remera azul", price: 15000, img: "assets/catalog/remera-azul.png", link: "producto.html", category: "remeras", materials: ["algodon"] },
    { name: "Camiseta Francisca blanca", price: 15000, img: "assets/catalog/musculosa.png", link: "producto.html", category: "remeras", materials: ["algodon"] },
    { name: "Sneaker Corsocomo Woman", price: 30000, img: "assets/catalog/zapatillas-2.png", link: "producto.html", category: "calzado", materials: ["poliester"] },
    { name: "Bandolera Frodo L", price: 30000, img: "assets/catalog/bandolera.png", link: "producto.html", category: "accesorios", materials: ["camaras"] },
    { name: "Pantalones cortos Beige", price: 20000, img: "assets/catalog/bermuda.png", link: "producto.html", category: "pantalones", materials: ["algodon", "lana"] },
];
