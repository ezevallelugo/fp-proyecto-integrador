  ...
  return (
    <header className={location.pathname === '/about' ? 'bg-[#e3f2fd] p-5' : ''}>
        ...
        <div className="flex justify-between items-center p-4 bg-white">
          <div className="flex w-full gap-5 items-center">
            ...
            <ul className="hidden lg:flex lg:flex-row lg:gap-5 list-none m-0 p-0">
              <li><Link to="/home" className="no-underline text-black hover:text-[#F1702A] text-[15px] transition-colors whitespace-nowrap" onClick={handleLinkClick}>Home</Link></li>
              <li><Link to="/catalog" className="no-underline text-black hover:text-[#F1702A] text-[15px] transition-colors whitespace-nowrap" onClick={handleLinkClick}>Productos</Link></li>
              <li><a href="#" className="no-underline text-black hover:text-[#F1702A] text-[15px] transition-colors whitespace-nowrap" onClick={handleLinkClick}>Servicios</a></li>
              <li><Link to="/about" className="no-underline text-black hover:text-[#F1702A] text-[15px] transition-colors whitespace-nowrap" onClick={handleLinkClick}>About us</Link></li>
            </ul>
      ...
      <ul className={`list-none m-0 p-0 w-full ${showMobileMenu ? 'flex flex-col items-end' : 'hidden'}`}>
        <li className="my-2 pr-4"><Link to="/home" className="no-underline text-black hover:text-[#F1702A] text-base" onClick={handleLinkClick}>Home</Link></li>
        <li className="my-2 pr-4"><Link to="/catalog" className="no-underline text-black hover:text-[#F1702A] text-base" onClick={handleLinkClick}>Productos</Link></li>
        <li className="my-2 pr-4"><a href="#" className="no-underline text-black hover:text-[#F1702A] text-base" onClick={handleLinkClick}>Servicios</a></li>
        <li className="my-2 pr-4"><Link to="/about" className="no-underline text-black hover:text-[#F1702A] text-base" onClick={handleLinkClick}>About us</Link></li>
